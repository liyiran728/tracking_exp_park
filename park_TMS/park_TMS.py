...
TR = 0.65 # 0.65 seconds per TR
totalTR = 385
taskTR = 385-16 # subtracting 16 initial scans at the beginning
taskTime = taskTR * TR # 239.85 seconds
...
# add fixation to the end of the study until designed time
while experimentTimer.getTime() < taskTime:
    fixCross.draw()
    win.flip()
# print(experimentTimer.getTime()) # should always be around 239.85
